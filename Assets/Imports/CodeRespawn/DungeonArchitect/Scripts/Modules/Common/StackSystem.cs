...
{
    public class StackSystem<TState, TStaticState, TResult>
    {   
        ...
        public delegate void ExecuteFrameDelegate(TState top, TStaticState staticState, StackSystem<TState, TStaticState, TResult> stackSystem);
