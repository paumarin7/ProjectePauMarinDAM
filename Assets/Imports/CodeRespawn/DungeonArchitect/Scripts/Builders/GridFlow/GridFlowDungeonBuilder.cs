...
namespace DungeonArchitect.Builders.GridFlow
{
    public class GridFlowDungeonBuilder : DungeonBuilder
    {
        ...
        void GenerateLevelLayout()
        {
            ...
            gridFlowModel.layoutGraph = null;
            ...
            if (!executor.Execute(execGraph, random, domainExtensions,100, out execNodeOutputRegistry))
            {
            ...
            else
            {
                ...
                gridFlowModel.layoutGraph = execState.State.GetState<FlowLayoutGraph>();
                gridFlowModel.tilemap = execState.State.GetState<FlowTilemap>();
                ...
                if (gridFlowModel.layoutGraph == null || gridFlowModel.tilemap == null)
                {
