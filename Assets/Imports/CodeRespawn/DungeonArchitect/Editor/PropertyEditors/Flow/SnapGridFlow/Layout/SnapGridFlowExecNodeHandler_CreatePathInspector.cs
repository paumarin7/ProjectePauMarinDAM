...
namespace DungeonArchitect.Editors.Flow.SnapGridFlow
{
    ...
    {
        private FlowInspectorMonoScriptProperty<ISGFLayoutNodePositionConstraint> positionConstraintScriptProperty;
        private FlowInspectorMonoScriptProperty<ISGFLayoutNodeCategoryConstraint> categoryConstraintScriptProperty;
        ...
        protected override void OnEnable()
        {
            ...
            // Create the position constraint script property
            {
                ...
                positionConstraintScriptProperty = new FlowInspectorMonoScriptProperty<ISGFLayoutNodePositionConstraint>(className);
            }
            
            // Create the module constraint script property
            {
                var className = (task != null) ? task.categoryConstraintScriptClassName : "";
                categoryConstraintScriptProperty = new FlowInspectorMonoScriptProperty<ISGFLayoutNodeCategoryConstraint>(className);
            }
        }
