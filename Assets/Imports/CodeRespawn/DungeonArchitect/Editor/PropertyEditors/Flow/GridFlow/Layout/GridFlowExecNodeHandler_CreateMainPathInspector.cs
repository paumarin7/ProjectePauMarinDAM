...
namespace DungeonArchitect.Editors.Flow.GridFlow
{
    ...
    public class GridFlowExecNodeHandler_CreateMainPathInspector : BaseFlowExecNodeHandler_CreateMainPathInspector
    {
        ...
        private FlowInspectorMonoScriptProperty<IGridFlowLayoutNodePositionConstraint> positionConstraintScriptProperty;
        ...
        protected override void OnEnable()
        {
            ...
            // Create the position constraint script property
            {
                ...
                positionConstraintScriptProperty = new FlowInspectorMonoScriptProperty<IGridFlowLayoutNodePositionConstraint>(className);
            }
        }
