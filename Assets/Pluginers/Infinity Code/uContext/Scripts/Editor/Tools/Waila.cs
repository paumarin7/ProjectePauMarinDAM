...
namespace InfinityCode.uContext.Tools
{
    ...
    public static class Waila
    {
        ...
        public static Action OnStartSmartSelection;
        ...
        static Waila()
        {
            SceneViewManager.AddListener(OnSceneGUI, 50, true);
